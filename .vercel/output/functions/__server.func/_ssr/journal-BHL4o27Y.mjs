//#region node_modules/.nitro/vite/services/ssr/assets/journal-BHL4o27Y.js
var ARTICLES = [
	{
	...
	},
	{
		...
		body: ["A stack is a sentence. Knife-edge, baguette, knife-edge. Or gold, gold, a single silver solitaire as a comma. Do not mix four textures unless you are on a campaign.", "Our configurator exists because the hand is not a moodboard. Build on a real silhouette, then add the stack at a bundle price — we take ten percent off three."]
	},
	{
		...
		body: ["Mahira’s small hoops in a white shirt did more for 22k than any award-show haar. Mawra’s pearl studs at a morning show. A single kangan on an otherwise bare wrist in a black sari.", "Copy the scale, not the costume. Sitara will not sell you a replica of a film set. We will sell you the piece that made the still worth keeping."]
	}
];
...
//#endregion
export { ARTICLE_BY_SLUG as n, ARTICLE_CATEGORY as r, ARTICLES as t };
